...
### 3. Business Impact
The `business-impact-engine.ts` translates physical downtime into financial exposure. It uses nominal throughputs and clinker margins (e.g., NGN 14,200/ton) to calculate the precise production loss cost per hour of downtime, making the "Cost-of-Failure" highly visible to executives.
